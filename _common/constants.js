...
// current congressional apportionment (number of US House seats per state, post-2020 census)
export const US_HOUSE_SEATS = {
    'AL': 7,
    'AK': 1,
    'AZ': 9,
    'AR': 4,
...
export const STATE_BOUNDING_BOXES = {
    ...
    'AK': [ [54.6, -174.1], [71.2, -128.8] ], // Smaller Alaska bbox away from dateline
